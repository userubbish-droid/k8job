    ...
    <?php if ($saved): ?>
        <div class="card" style="margin-bottom: 20px;">
            <div style="margin-top: 12px; padding-top: 12px; border-top: 1px solid var(--border); font-size: 14px;">
                <div style="margin-bottom: 4px;"><strong><?= htmlspecialchars($saved_mode) ?></strong> <?= htmlspecialchars($saved_code ?: '—') ?> <?= htmlspecialchars($saved_product ?: '—') ?> · <strong><?= htmlspecialchars(__('txn_saved_total_word'), ENT_QUOTES, 'UTF-8') ?> <?= number_format($saved_total, 2) ?></strong></div>
