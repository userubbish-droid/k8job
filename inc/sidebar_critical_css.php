...
.dashboard-sidebar { display: flex !important; flex-direction: column !important; flex-wrap: nowrap !important; width: 228px !important; min-width: 228px !important; background: linear-gradient(180deg, #1e3a5f 0%, #1a3352 50%, #152a47 100%); border-right: 1px solid rgba(0,0,0,0.2); padding: 0 0 20px; flex-shrink: 0; }
.dashboard-sidebar .nav-item { display: flex !important; width: 100%; box-sizing: border-box; padding: 12px 20px; margin: 0 12px 6px 12px; color: rgba(255,255,255,0.85); text-decoration: none; border-radius: 8px; white-space: nowrap; align-items: center; }
