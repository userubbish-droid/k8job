...
<aside class="dashboard-sidebar">
    ...
    <?php endif; ?>
    <?php if (has_permission('transaction_create')): ?><a href="expense.php" class="nav-item <?= $sidebar_current === 'expense_create' ? 'primary' : '' ?>"><span class="nav-icon"></span>Expense</a><?php endif; ?>
